...
const Blog = () => {
    return (
        <div className='w-4/5 m-40 border-2 mx-auto p-2 rounded-md'>
            ...
            <div className='bg-purple-200 p-4 rounded-md m-4'>
                <h1 className='font-bold text-2xl my-4'>2. What is custom hooks ?</h1>
            ...
            <div className='bg-purple-200 p-4 rounded-md m-4'>
                <h1 className='font-bold text-2xl my-4'>3. What is useRef ?</h1>
            ...
            <div className='bg-purple-200 p-4 rounded-md m-4'>
                <h1 className='font-bold text-2xl my-4'>4. What is useMemo ?</h1>
